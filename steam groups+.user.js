	...
	for (let i = 0; i < elems.length; i++){
		...
		setTimeout(() => {
			...
			.then(body => {
				...
				let tag = parsing.getElementsByClassName("grouppage_header_abbrev")[0].innerHTML;
				let founded = parsing.getElementsByClassName("data")[0].innerHTML;
				let owner = profileUrl == parsing.getElementsByClassName("member_sectionheader")[0].nextElementSibling.childNodes[1].href;
